...
auto ob = &earth; // Change here for different planet
celestial planet = celestial(ob->sgp, ob->sMa, ob->flat, ob->sma, ob->ecc, ob->J2);//initialisation value, have this in start-up of final code